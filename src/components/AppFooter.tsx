        ...
        <Col span={8}>
          <div className="column" style={{ textAlign: "left", color: "white" }} >
            ...
            <li style={{ listStyleType: "none" }} className="nav-item" >
              <a href="#" style={textStyle}>Social:</a>
            </li>
            ...
            <li style={{ listStyleType: "none" }} className="nav-item" >
              <a href="#" style={textStyle}>Store:</a>
            </li>
        ...
        <Col span={4}>
          <div className="column" style={{ textAlign: "left", color: "white" }} >
            ...
            <ul style={{ display: "flex", flexDirection: "column", padding: "0" }}>
              <li className="nav-item"><a href="#" style={textStyle}>About us</a></li>
              <li className="nav-item"><a href="#" style={textStyle}>Contact us</a></li>
              <li className="nav-item"><a href="#" style={textStyle}>Blog</a></li>
              <li className="nav-item"><a href="#" style={textStyle}>License</a></li>
            </ul>
          </div>
        </Col>
        <Col span={4}>
          <div className="column" style={{ textAlign: "left", color: "white" }} >
            ...
            <ul style={{ display: "flex", flexDirection: "column", padding: "0" }}>
              <li className="nav-item"><a href="#" style={textStyle}>Support</a></li>
              <li className="nav-item"><a href="#" style={textStyle}>Jobs</a></li>
              <li className="nav-item"><a href="#" style={textStyle}>Privacy</a></li>
              <li className="nav-item"><a href="#" style={textStyle}>Guides</a></li>
              <li className="nav-item"><a href="#" style={textStyle}>Pricing</a></li>
            </ul>
          </div>
        </Col>
        <Col span={8}>
